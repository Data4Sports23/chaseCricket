...
/**
 * Create don 17/11/2021
 * for preview the selected 11
 */
public class ConfirmAXI extends AppCompatActivity {
    ...
    int matchid;
    String matchID, teamA, confirm_head = " - Selected Players";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.confirm_axi);
        ...
        tv_team = findViewById(R.id.ca_team);
        table = findViewById(R.id.ca_table);

        tv_team.setText(teamA + confirm_head);

        selectedPID =  (ArrayList<Integer>) getIntent().getSerializableExtra("mylist");
        displayPreviewList();
        Log.d("CAXI", "myList = " + selectedPID.toString());

        findViewById(R.id.ca_confirm).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    void confirmed() {
        ...
        startActivity(new Intent(ConfirmAXI.this, SelectTeamBXIActivity.class));
        finish();
    }
